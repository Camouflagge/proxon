...
PLATFORMS_LIST = [Platform.SENSOR, Platform.SWITCH, Platform.CLIMATE, Platform.NUMBER, Platform.SELECT]

async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    hub = ProxonModbusHub(
        hass=hass, host=entry.data[CONF_HOST],
    ...
    if not await hub.async_connect(): return False
